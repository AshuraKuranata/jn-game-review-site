...
const SignupForm = (props) => {
    ...
    const handleSubmit = async (event) => {
        try {
            ...
            const Response = await fetch("http://34.227.48.9:3090/auth/sign-up", {
                method: 'POST',
                headers: {
    ...
    return (
        <form className="signup-form"action="http://34.227.48.9:3090/auth/sign-up" method="POST" onSubmit={handleSubmit}>
